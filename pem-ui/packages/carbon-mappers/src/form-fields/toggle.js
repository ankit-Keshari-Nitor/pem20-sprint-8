...
import { FORM_FIELD_GROUPS, FORM_FIELD_LABEL, FORM_FIELD_TYPE, NameLabel, helperText, labelA, labelB, readOnly, labelText, isRequired } from '../constant';
...
Toggle.config = {
  ...
  icon: <ToggleIcon />,
  editableProps: {
    Basic: [NameLabel, labelText, helperText, labelA, labelB, readOnly],
    Condition: []
  },
