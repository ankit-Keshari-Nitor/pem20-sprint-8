...
import { FORM_FIELD_GROUPS, FORM_FIELD_LABEL, FORM_FIELD_TYPE, NameLabel, helperText, hrefText, labelText } from '../constant';
...
Link.config = {
  ...
  icon: <LinkIcon />,
  editableProps: {
    Basic: [NameLabel, labelText, hrefText, helperText]
  },
  advanceProps: []
};
