...
import { FORM_FIELD_GROUPS, FORM_FIELD_LABEL, FORM_FIELD_TYPE, helperText, placeHolder, NameLabel, readOnly, isRequired, labelText } from '../constant';
...
DatePicker.config = {
  ...
  icon: <DatepickerIcon />,
  editableProps: {
    Basic: [NameLabel, labelText, helperText, placeHolder, readOnly],
    Condition: []
  },
