...
const type = formFieldType.FORM_FIELD_TYPE.TEXT_INPUT;
const TextInput = _ref => {
  ...
  }), /*#__PURE__*/React.createElement(react.TextInput, _rollupPluginBabelHelpers.extends({
    "data-testid": id,
    id: id,
    type: type,
    labelText: "",
...
TextInput.config = {
  ...
  label: 'Text Input',
  group: 'basic-input',
  icon: /*#__PURE__*/React.createElement(iconsReact.Txt, null),
  editableProps: {
