...
class ActivityVersionControllerTest {
    ...
    void updateMarkAsFinal() throws Exception {
        ...
        MarkAsFinalActivityDefinitionVersionResp resp = activityVersionController.markActivityDefinitionStatusAsFinal("hsbc","fd2dfe53-b38c-40cf-acb7-9850d1930858","9ec7e29e-9cbe-4298-bb67-a53f86868592");
        assertNotNull(resp);
