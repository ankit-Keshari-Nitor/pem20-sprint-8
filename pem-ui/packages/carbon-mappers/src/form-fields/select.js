...
import { FORM_FIELD_GROUPS, FORM_FIELD_LABEL, FORM_FIELD_TYPE, elementTyps, options, helperText, Id, placeHolder, labelText, readOnly, isRequired } from '../constant';
...
Select.config = {
  ...
  icon: <SelectIcon />,
  editableProps: {
    Basic: [elementTyps, Id, labelText, placeHolder, helperText, options, readOnly],
    Condition: []
  },
