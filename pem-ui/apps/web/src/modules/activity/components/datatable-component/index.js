    ...
    return (
      <OverflowMenu size="sm" flipped className="always-visible-overflow-menu">
        ...
        {status !== 'DELETE' && status !== 'FINAL' && (
          <OverflowMenuItem className="activity-edit-overflow-menu" itemText={ACTION_COLUMN_KEYS.EDIT} onClick={() => onCellActionClick(ACTION_COLUMN_KEYS.EDIT, id)} />
        )}
        {!showDrawer ? (
          <>
            <OverflowMenuItem
